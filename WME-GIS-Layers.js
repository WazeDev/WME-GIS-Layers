...
(function() {
    ...
    let _gisLayers = [
        ...
        {name:  'Crane Co - Parcels',
         ...
         labelFields:  ['CraneCad.DBO.Accounts.situs_num', 'CraneCad.DBO.Accounts.situs_street_prefx', 'CraneCad.DBO.Accounts.situs_street', 'CraneCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
        ...
        {name:  'Johnson Co - Parcels',
         ...
         labelFields:  ['JohnsonCad.DBO.Accounts.situs_num', 'JohnsonCad.DBO.Accounts.situs_street_prefx', 'JohnsonCad.DBO.Accounts.situs_street', 'JohnsonCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
        ...
        {name: 'Kerr Co - Parcels',
         ...
         url: 'https://webmap.trueautomation.com/arcgis/rest/services/KendallMapSearch/MapServer/4',
        ...
        {name:  'La Salle Co - Parcels',
         ...
         url:  'https://gis.bisconsultants.com/bisgis/rest/services/La SalleWeb/MapServer/0',
         labelFields:  ['La SalleCad.DBO.Accounts.situs_num', 'La SalleCad.DBO.Accounts.situs_street_prefx', 'La SalleCad.DBO.Accounts.situs_street', 'La SalleCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
        ...
        {name:  'Marion Co - Parcels',
         ...
         url:  'https://gis.bisconsultants.com/bisgis/rest/services/MarionWeb/MapServer/0',
         labelFields:  ['MarionCad.DBO.Accounts.situs_num', 'MarionCad.DBO.Accounts.situs_street_prefx', 'MarionCad.DBO.Accounts.situs_street', 'MarionCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
        ...
        {name:  'Red River Co - Parcels',
         ...
         url:  'https://gis.bisconsultants.com/bisgis/rest/services/Red RiverWeb/MapServer/0',
         labelFields:  ['Red RiverCad.DBO.Accounts.situs_num', 'Red RiverCad.DBO.Accounts.situs_street_prefx', 'Red RiverCad.DBO.Accounts.situs_street', 'Red RiverCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
...
//         style: DEFAULT_PARCEL_STYLE},
        ...
        {name:  'Terrell Co - Parcels',
         ...
         labelFields:  ['TerrellCad.DBO.Accounts.situs_num', 'TerrellCad.DBO.Accounts.situs_street_prefx', 'TerrellCad.DBO.Accounts.situs_street', 'TerrellCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
        ...
        {name:  'Van Zandt Co - Parcels',
         ...
         url:  'https://gis.bisconsultants.com/bisgis/rest/services/Van ZandtWeb/MapServer/0',
         labelFields:  ['Van ZandtCad.DBO.Accounts.situs_num', 'Van ZandtCad.DBO.Accounts.situs_street_prefx', 'Van ZandtCad.DBO.Accounts.situs_street', 'Van ZandtCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
        ...
        {name: 'Waller Co - Parcels',
         ...
         url: 'https://webmap.trueautomation.com/arcgis/rest/services/WallerMapSearch/MapServer/7',
        ...
        {name:  'Washington Co - Parcels',
         ...
         labelFields:  ['WashingtonCad.DBO.Accounts.situs_num', 'WashingtonCad.DBO.Accounts.situs_street_prefx', 'WashingtonCad.DBO.Accounts.situs_street', 'WashingtonCad.DBO.Accounts.situs_street_sufix' ],
         processLabel:  function(label) { return label.replace(/^([-\d]+)\s+([^,]+).*/,'$1\n$2'); },
         state:  'TX',
         style:  DEFAULT_PARCEL_STYLE },
